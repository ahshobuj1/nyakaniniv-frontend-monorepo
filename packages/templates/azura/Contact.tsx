  ...
  return (
    <motion.section
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-[80px]">
        <h2 className="text-[#0f0f0f] font-bold text-[40px] mb-12 text-center">Get in Touch</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl flex flex-col items-center text-center gap-4">
            ...
            <p className="text-[#787878]">{content?.email || 'contact@example.com'}</p>
          </div>
          <div className="bg-white p-8 rounded-2xl flex flex-col items-center text-center gap-4">
            <div className="size-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center">
            ...
            <p className="text-[#787878]">{content?.phone || '+1 234 567 890'}</p>
          </div>
          <div className="bg-white p-8 rounded-2xl flex flex-col items-center text-center gap-4">
            <div className="size-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center">
            ...
            <p className="text-[#787878]">{content?.location || 'Lagos, Nigeria'}</p>
          </div>
        </div>
      </div>
    </motion.section>
