...
export default function Footer({content}: FooterProps) {
  ...
  const djStageName = content?.djName || content?.navbar?.djName || content?.footer?.logoText || footerData.logoText || 'DJ';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[60px] md:gap-[100px] mb-[60px]">
          <div className="flex flex-col gap-[20px]">
            ...
            <div className="flex gap-[12px] mt-2">
              <Link
                href={content?.social?.instagram || footerData.instagram || '#'}
              ...
              <Link
                href={content?.social?.facebook || footerData.facebook || '#'}
                className="w-[40px] h-[40px] rounded-full bg-[#333333] flex items-center justify-center text-white hover:bg-[var(--primary)] transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
              ...
              <Link
                href={content?.social?.linkedin || footerData.linkedin || '#'}
                className="w-[40px] h-[40px] rounded-full bg-[#333333] flex items-center justify-center text-white hover:bg-[var(--primary)] transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
          ...
          <div className="flex flex-col gap-[24px]">
            ...
            <ul className="flex flex-col gap-[20px] text-[#a3a3a3] text-[16px]">
              <li className="flex items-center gap-[12px]">
                ...
                {content?.contact?.email || footerData.contactEmail}
              </li>
              <li className="flex items-center gap-[12px]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                {content?.contact?.phone || footerData.contactPhone}
              </li>
              <li className="flex items-center gap-[12px]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                {content?.contact?.location || footerData.contactLocation}
              </li>
            </ul>
          </div>
        </div>
